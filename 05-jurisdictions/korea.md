...
**Status: the high-performance AI category below was re-verified against primary text on 13 August 2026 (KST). The remainder of this guide is current as at early July 2026 and was not re-verified in this revision. Korea's AI Framework Act and its Enforcement Decree are in force. A grace period on administrative fines runs through the first year of enforcement. Verify current status before relying on anything below.**
